      ...
      <Box sx={{ mb: 3 }}>
        ...
        <Box sx={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 2, mb: 2 }}>
          <TextField
            ...
            value={formData.contractsTraded}
            onChange={(e) => handleInputChange('contractsTraded', e.target.value)}
            size="small"
            type="number"
            sx={{ 
              '& .MuiOutlinedInput-root': {
          ...
          <TextField
            ...
            onChange={(e) => handleInputChange('ticks', e.target.value)}
            size="small"
            type="number"
            sx={{ 
              '& .MuiOutlinedInput-root': {
          ...
          <TextField
            ...
            value={formData.ticksPerContract}
            onChange={(e) => handleInputChange('ticksPerContract', e.target.value)}
            size="small"
            type="number"
            sx={{ 
              '& .MuiOutlinedInput-root': {
        ...
        <Box sx={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 2, mb: 2 }}>
          <TextField
            ...
            value={formData.commissionsAndFees}
            onChange={(e) => handleInputChange('commissionsAndFees', e.target.value)}
            size="small"
            placeholder="$0.00"
            sx={{ 
              '& .MuiOutlinedInput-root': {
          ...
          <TextField
            ...
            onChange={(e) => handleInputChange('netROI', e.target.value)}
            size="small"
            placeholder="0.00%"
            sx={{ 
              '& .MuiOutlinedInput-root': {
          ...
          <TextField
            fullWidth
            label="Gross P&L"
            value={formData.grossPL}
            onChange={(e) => handleInputChange('grossPL', e.target.value)}
            size="small"
            placeholder="$0.00"
            sx={{ 
              '& .MuiOutlinedInput-root': {
          ...
          <TextField
            ...
            onChange={(e) => handleInputChange('adjustedCost', e.target.value)}
            size="small"
            placeholder="$0.00"
            sx={{ 
              '& .MuiOutlinedInput-root': {
        ...
        <Box sx={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 2, mb: 2 }}>
          <TextField
            fullWidth
            label="Price MAE"
            value={formData.priceMAE}
            onChange={(e) => handleInputChange('priceMAE', e.target.value)}
            size="small"
            placeholder="$0.00"
            helperText="Max Adverse Excursion"
            sx={{ 
              '& .MuiOutlinedInput-root': {
                transition: 'all 0.3s ease',
                '&:hover': { boxShadow: 'var(--shadow-soft)' }
          ...
          <TextField
            fullWidth
            label="Price MFE"
            value={formData.priceMFE}
            onChange={(e) => handleInputChange('priceMFE', e.target.value)}
            size="small"
            placeholder="$0.00"
            helperText="Max Favorable Excursion"
            sx={{ 
              '& .MuiOutlinedInput-root': {
                transition: 'all 0.3s ease',
                '&:hover': { boxShadow: 'var(--shadow-soft)' }
          ...
          <TextField
            ...
            onChange={(e) => handleInputChange('averageEntry', e.target.value)}
            size="small"
            placeholder="$0.00"
            sx={{ 
              '& .MuiOutlinedInput-root': {
          ...
          <TextField
            ...
            onChange={(e) => handleInputChange('averageExit', e.target.value)}
            size="small"
            placeholder="$0.00"
            sx={{ 
              '& .MuiOutlinedInput-root': {
        ...
        <Box sx={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 2, mb: 2 }}>
          ...
          <TextField
            ...
            onChange={(e) => handleInputChange('initialTarget', e.target.value)}
            size="small"
            placeholder="$0.00"
            sx={{ 
              '& .MuiOutlinedInput-root': {
          ...
          <TextField
            ...
            onChange={(e) => handleInputChange('tradeRisk', e.target.value)}
            size="small"
            placeholder="$0.00"
            sx={{ 
              '& .MuiOutlinedInput-root': {
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
              {[1, 2, 3, 4, 5].map((star) => (
                <Star
                  key={star}
                  size={20}
                  fill={star <= (formData.tradeRating || 0) ? "#fbbf24" : "none"}
                  color={star <= (formData.tradeRating || 0) ? "#fbbf24" : "#d1d5db"}
                  onClick={() => handleInputChange('tradeRating', star)}
        ...
        <Box sx={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 2 }}>
          <TextField
            ...
            onChange={(e) => handleInputChange('plannedRMultiple', e.target.value)}
            size="small"
            placeholder="0.00"
            sx={{ 
              '& .MuiOutlinedInput-root': {
          ...
          <TextField
            ...
            onChange={(e) => handleInputChange('realizedRMultiple', e.target.value)}
            size="small"
            placeholder="0.00"
            sx={{ 
              '& .MuiOutlinedInput-root': {
          ...
          <TextField
            fullWidth
            label="Best Exit Price"
            value={formData.bestExitPrice}
            onChange={(e) => handleInputChange('bestExitPrice', e.target.value)}
            size="small"
            placeholder="$0.00"
            sx={{ 
              '& .MuiOutlinedInput-root': {
          ...
          <TextField
            ...
            value={formData.bestExitTime}
            onChange={(e) => handleInputChange('bestExitTime', e.target.value)}
            size="small"
